...
START_DATE=204001 # Start year and month for processing (if not given in command line YYYYMM)
STOP_DATE=205012  # End year and month for processing (if not given in command line YYYYMM)
...
ARCH_BASE=/nobackup/rossby18/sm_anddo/HCLIM38h1_FPSconvection_AROME_ALD_ECE_RCP85_2040_2050 # directory where the raw data of the simulations are archived
...
WORKDIR=${DATADIR}/work/post/FcpECE2040 # work directory, CAUTION: WITH OPTION "--clean" ALL FILES IN THIS FOLDER WILL BE DELETED AFTER PROCESSING!
...
EXPPATH=FcpECE2040                   # directory of the experiment
NAMETAG=FPS3_HCLIM38h1_FPSconvection_AROME_ALD_ECE_RCP85_2040_2050    # file nameing, i.e. var_NAMETAG_date.nc
